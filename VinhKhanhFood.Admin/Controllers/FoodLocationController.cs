...
namespace VinhKhanhFood.Admin.Controllers
{
    public class FoodLocationController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var response = await client.GetAsync("http://192.168.1.2:5020/api/Food/all");
        ...
        public async Task<IActionResult> Create([FromForm] FoodLocation model)
        {
            try
            {
                ...
                var response = await client.PostAsync("http://192.168.1.2:5020/api/Food", content);
        ...
        public async Task<IActionResult> Translate(int id)
        {
            ...
            {
                var client = _httpClientFactory.CreateClient();
                var getRes = await client.GetAsync($"http://192.168.1.2:5020/api/Food/{id}");
                ...
                using (var content = new MultipartFormDataContent())
                {
                    ...
                    var request = new HttpRequestMessage(HttpMethod.Put, $"http://192.168.1.2:5020/api/Food/{id}") { Content = content };
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            {
                var client = _httpClientFactory.CreateClient();
                var deleteRes = await client.DeleteAsync($"http://192.168.1.2:5020/api/Food/{id}");
        ...
        public async Task<IActionResult> ToggleStatus(int id, string currentStatus)
        {
            try
            {
                ...
                var patchRes = await client.PatchAsync($"http://192.168.1.2:5020/api/Food/{id}/status", content);
